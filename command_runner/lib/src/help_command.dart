...
// When given a command as a argument, it prints the usage of
// that command only, including its options and other details.
// When a flag 'verbose' is set, it prints options and details for all commands

// This command isn't automatically added to CommandRUnner instances.
// Package users sjhould add it themselves with [CommandRunner.addCommand],
